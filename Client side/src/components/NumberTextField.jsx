// The component responsible for present the inputs with one select option in all the pages
...
export default function NumberTextField(props) {
  ...
  return (
    <Box backgroundColor={colors.primary[400]} width={130}>
      <Autocomplete
        value={props.value}
        ...
        renderOption={(props, results) => (
          <Box component="li" {...props} key={results}>
            {results}
          </Box>
        )}
